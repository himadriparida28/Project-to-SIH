  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-[#FFD166] font-sans overflow-y-auto">
      ...
      >
        ...
        {/* ── CHANGE 3: Header ── */}
        <header className="relative z-50 px-10 py-5">
            ...
            <div className="flex gap-8 items-center text-sm">
              ...
              <div className="relative z-50">
                <button
                  ...
                  className="font-bold hover:text-violet-600 cursor-pointer flex items-center gap-1.5 text-slate-700 focus:outline-none"
                >
              ...
              <button
                ...
                className="font-bold hover:text-violet-600 cursor-pointer flex items-center gap-1.5 focus:outline-none"
              >
                🎧 Help Center
              </button>
            </div>
        ...
        <main className="relative z-10 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 pl-6 pr-6 md:pl-12 md:pr-6 lg:pr-0 items-center max-w-[1440px] mx-auto w-full">
          ...
          <div className="hidden lg:block lg:col-span-3 relative h-[380px] select-none pointer-events-none">
            ...
            {/* Aadhaar Card (Top Left - aligned with Ayushman Card horizontally) */}
            <motion.div
              animate={{
                y: [0, -12, 0],
                rotate: [0, 2, -2, 0],
              ...
              className="absolute top-4 left-4 w-[130px] shadow-2xl pointer-events-none z-10"
            >
              <img src={aadhaarImg} className="w-full h-auto rounded-xl border border-white/50" alt="Aadhaar Card" />
            </motion.div>

            {/* Ration Card (Middle Right - exactly 124px vertical shift down from Aadhaar) */}
            <motion.div
              animate={{
                y: [0, -12, 0],
                rotate: [0, 2, -2, 0],
              ...
              className="absolute top-[128px] right-4 w-[120px] shadow-2xl pointer-events-none z-10"
            >
              <img src={rationImg} className="w-full h-auto rounded-xl border border-white/50" alt="Ration Card" />
            </motion.div>

            {/* Ayushman Card (Bottom Left - exactly 124px vertical shift down from Ration, aligned with Aadhaar) */}
            <motion.div
              animate={{
                y: [0, -12, 0],
                rotate: [0, 2, -2, 0],
              ...
              className="absolute top-[252px] left-4 w-[130px] shadow-2xl pointer-events-none z-10"
            >
